...
<div style="padding:0 16px;">
  <p>Ние сме частни центрове за обучение на хора, по чужди езици. Нашите учители разбират вашите изисквания и се 
  съобразяват с времето и мястото, където искате да се проведат обученията.</p>
