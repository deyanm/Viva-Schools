...
<body>
	<div class="login-block"> 
        <form action="ChangePasswordServlet">
            ...
            <input type="password" class="field" placeholder="Повторете паролата *" name="pass2" />
            <button type="submit" id="button">Промени паролата</button>
        </form>
	</div>
